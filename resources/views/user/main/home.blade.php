                        ...
                        <div class="navbar-nav ml-auto py-0 d-none d-lg-block">
                            ...
                            <div class="dropdown d-inline">
                                <a class="btn text-white  dropdown-toggle" href="#" role="button"
                                    ...
                                    <i class="fa-solid fa-user text-white "></i> {{ Auth::user()->name }}
                                </a>
                            ...
                            <form class="d-inline" action="{{ route('logout') }}" method="POST">
                                @csrf
                                <button type="submit" class="btn rounded mx-1 text-white bg-dark ">Log Out
                    ...
                    <form>
                        ...
                        @foreach ($category as $c)
                            <div
                                ...
                                <label class="w-100 shadow-sm px-1" for="price-1">{{ $c->name }}</label>
