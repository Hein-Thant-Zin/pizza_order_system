                ...
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            <a href="{{ route('user#home') }}" class="nav-item nav-link active"><i
                        ...
                        <div class="navbar-nav ml-auto py-0 d-none d-lg-block">
                            ...
                            <div class="btn-group">
                                <button type="button" class="btn text-white btn-sm  dropdown-toggle"
                                    data-toggle="dropdown"> <i
                                        class="fa-solid fa-user text-white mr-2"></i>{{ Auth::user()->name }}</button>
                                <div class="dropdown-menu">
                                    <a class="dropdown-item py-2" href="{{ route('user#details') }}">Account</a>
                                    <a class="dropdown-item py-2 mb-2"
                                        href="{{ route('user#changePasswordPage') }}">Change Password</a>
                                    <span>
                                        <form class="d-inline" action="{{ route('logout') }}" method="POST">
                                            @csrf
                                            <button type="submit" class="ml-4 mb-2 p-1 rounded text-white bg-dark ">Log
                                                Out
                            ...
                            {{-- <a href="" class="btn px-0 ml-3">
                                <i class="fa-solid fa-user text-white hover"></i>
