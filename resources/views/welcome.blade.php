        ...
        <div class="row px-xl-5">
            ...
            <div class="col-lg-3 col-md-4">
                ...
                <h5 class="section-title position-relative text-uppercase mb-3"><span class="bg-secondary pr-3">Filter
                        by category</span></h5>
                {{-- <a href="{{ route('api') }}"><button class="form-control">Api</button></a> --}}
            ...
            <div class="col-lg-9 col-md-8">
                <div class="row pb-3">
                    ...
                    <div class="row  mx-2 " id="dataList">
                        ...
                        @foreach ($pizza as $p)
                            <div class="col-lg-4  pt-4 bg-light shadow-current col-md-6 mb-5 col-sm-6 pb-1">
                                ...
                                <div class="text-center ">
                                    ...
                                    <div class="d-flex align-items-center justify-content-center mt-2">
                                        <h5>{{ $p->price }}</h5>
                                        <h6 class="text-muted ml-2"><del class="">5000 $</del></h6>
                                    </div>
                                    <div class="d-flex align-items-center justify-content-center mb-1">
                                        <small class="fa fa-star text-primary mr-1"></small>
                                        <small class="fa fa-star text-primary mr-1"></small>
            ...
            <!-- Shop Product End -->
            <a href="{{ route('route#cacheClear') }}"><button class="btn btn-success">Run</button></a>
        </div>
    </div>
@endsection
